...
Coletamos apenas os dados que você informa voluntariamente nos formulários do site:
...
1. Retornar o seu contato comercial sobre inspeção de purgadores e sobre o sistema Oikos;
2. Preparar a proposta técnica e comercial adequada ao porte da sua planta;
3. Manter o registro da negociação em nossa base comercial.
...
Mantemos os dados de contato enquanto durar a relação comercial e, após o encerramento, pelo prazo necessário ao cumprimento de obrigações legais ou à defesa de eventuais direitos. Encerrado esse prazo, os dados são eliminados.
...
Para exercer qualquer um desses direitos, escreva para **comercial@oikos.eco.br**. Respondemos em até 15 dias.

## Segurança

Adotamos medidas técnicas e administrativas para proteger os dados contra acesso não autorizado, perda e destruição, incluindo transmissão criptografada (HTTPS) e restrição de acesso à base comercial.

## Alterações

Esta política pode ser atualizada. A data da última atualização está indicada no início do documento.
